...
import useArticleQuery from '@/composables/useArticleQuery'
...
<template>
  <div class="container mx-auto py-7 px-12">
    <button class="bg-success flex text-white items-center gap-6 py-2 px-4 rounded ml-auto mb-6">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
    ...
    <!-- Card -->
    <ArticleCard v-if="articles" :articles="articles" />
